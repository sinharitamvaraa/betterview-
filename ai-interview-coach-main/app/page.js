...
<div className="mt-8 grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
      ...
      >
       <ReceiptText className='h-8 w-8'/>
        ...
        <h2 className="mt-4 text-xl font-bold text-black">Give Job Description</h2>

        <p className="mt-1 text-sm text-gray-600">
          Enter the Job details like Job Title, Company Name, Job Description, and other details.
        </p>
      </a>
      ...
      <Focus className='h-8 w-8'/>
        ...
        <h2 className="mt-4 text-xl font-bold text-black">Give Interview</h2>

        <p className="mt-1 text-sm text-gray-600">
           You will get 5 questions based on your Job profile and Experience. Answer them to get feedback.
        </p>
      </a>
      ...
      <AtomIcon className='h-8 w-8'/>
        ...
        <h2 className="mt-4 text-xl font-bold text-black">Get Feedback of Your Interview</h2>

        <p className="mt-1 text-sm text-gray-600">
           Based on your interview answers, the AI will provide you feedback on your performance.
        </p>
      </a>
